...
public class UsingJCAPI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lajittele matkustajanumeron perusteella (Yhdistelmäoperaatiot):");

        cardUsers
        	.stream()
        	.sorted((TrafficCard tc1, TrafficCard tc2) -> Integer.compare(tc1.mTravellerNumber, tc2.mTravellerNumber))
